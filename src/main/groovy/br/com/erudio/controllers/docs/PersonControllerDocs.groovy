            ...
            @ApiResponse(
                ...
                content = [
                    @Content(
                        ...
                        array = @ArraySchema(schema = @Schema(implementation = PersonDTO))
                    )
                ]),
    ...
    @Operation(summary = 'Massive People Creation',
        ...
        responses = [
            @ApiResponse(
                ...
                responseCode = '200',
                content = [
                    @Content(schema = @Schema(implementation = PersonDTO))
                ]),
            @ApiResponse(description = 'No Content', responseCode = '204', content = @Content),
            @ApiResponse(description = 'Bad Request', responseCode = '400', content = @Content),
            @ApiResponse(description = 'Unauthorized', responseCode = '401', content = @Content),
    ...
    @Operation(summary = 'Finds a Person',
        ...
        responses = [
            @ApiResponse(
                description = 'Success',
                responseCode = '200',
                content = @Content(schema = @Schema(implementation = PersonDTO))
            ),
            @ApiResponse(description = 'No Content', responseCode = '204', content = @Content),
            @ApiResponse(description = 'Bad Request', responseCode = '400', content = @Content),
            @ApiResponse(description = 'Unauthorized', responseCode = '401', content = @Content),
